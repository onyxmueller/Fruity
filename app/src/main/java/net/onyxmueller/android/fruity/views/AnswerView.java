...
public class AnswerView extends RadioGroup implements RadioGroup.OnCheckedChangeListener {
    ...
    private OnAnswerSelectedListener selectedListener;
    ...
    public boolean isCorrectAnswerSelected() {
        ...
        return (selected != null) && TextUtils.equals(selected.getText(), correctAnswer);
    }
    ...
    public void onCheckedChanged(RadioGroup group, int checkedId) {
        if (selectedListener != null) {
            if (isCorrectAnswerSelected()) {
                selectedListener.onCorrectAnswerSelected();
            } else {
                selectedListener.onWrongAnswerSelected();
            }
        }
    }
}
