    ...
    public static void scheduleAlarm(Context context) {
        ...
        if (enabled) {
            ...
            try {
                ...
                alarmTime.setTime(format.parse(alarmPref));

                startTime.set(Calendar.HOUR_OF_DAY, alarmTime.get(Calendar.HOUR_OF_DAY));
                startTime.set(Calendar.MINUTE, alarmTime.get(Calendar.MINUTE));
